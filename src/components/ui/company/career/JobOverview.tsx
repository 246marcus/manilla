    ...
    <div className="px-4 md:px-8 lg:px-16 py-10">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-300 text-sm leading-relaxed">
          We are searching for a brilliant and data-driven Senior Growth Hack Specialist to join
          our team. In this fast-paced role, you'll be a key player in developing and executing
          innovative growth hacking strategies that propel our company forward.
        </p>
      </div>
