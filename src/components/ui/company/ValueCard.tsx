...
const ValueCard: React.FC<ValueCardProps> = ({
  ...
  return (
    <div
      className={`md:flex-5/12 max-w-md md:max-w-3xl bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col items-center justify-center ${xprop}`}
    >
